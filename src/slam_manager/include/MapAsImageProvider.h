...
private:
    ...
    int32_t thresh_occupancy;
    bool enable_map_tile_publisher;

public:
    MapAsImageProvider(ros::NodeHandle nh,int32_t thresh_occ, uint16_t tile_width = INITIAL_TILE_SIZE_X, uint16_t tile_height = INITIAL_TILE_SIZE_Y, bool robot_indicator = true, bool full_map = true, bool map_tile = true);
    ~MapAsImageProvider();
