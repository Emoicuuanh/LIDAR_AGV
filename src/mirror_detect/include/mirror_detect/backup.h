...
#include <mirror_detect/DetectionNodeConfig.h>
...
public:
  ...
  dynamic_reconfigure::Server<mirror_detect::DetectionNodeConfig> dr_srv_;
 ...
 visualization_msgs::MarkerArray marker_array;
  ...
  void startDynamicReconfigureServer()
  {
    ...
    dynamic_reconfigure::Server<mirror_detect::DetectionNodeConfig>::CallbackType cb;
  ...
  void startPub()
  {
    ...
    myPoint_min = nh_.advertise<geometry_msgs::PointStamped>("mirror_detect/point_min", 1);
    myPoint_max = nh_.advertise<geometry_msgs::PointStamped>("mirror_detect/point_max", 1);

    clusters_cloud_pub_ = nh_.advertise<sensor_msgs::PointCloud2>("mirror_detect/clustersCloud", 1);
    clusters_pub_ = nh_.advertise<mirror_detect::ClusterArray>("mirror_detect/clusters", 1);

    lines_cloud_pub_ = nh_.advertise<sensor_msgs::PointCloud2>("mirror_detect/linesCloud", 1);
    lines_pub_ = nh_.advertise<mirror_detect::LineArray>("mirror_detect/lines", 1);
    line_marker_pub_ = nh_.advertise<visualization_msgs::Marker>("mirror_detect/lines_marker", 1);

    dock_marker_pub_ = nh_.advertise<visualization_msgs::Marker>("mirror_detect/dock_marker", 1);
    dock_pose_marker_pub_ = nh_.advertise<visualization_msgs::Marker>("mirror_detect/dock_pose_marker", 1);
    dock_pose_pub_ = nh_.advertise<geometry_msgs::PoseStamped>("mirror_detect/dock_pose", 1);
    bbox_pub_ = nh_.advertise<mirror_detect::BoundingBox>("mirror_detect/bbox", 1);

    debug_pub_ = nh_.advertise<sensor_msgs::PointCloud2>("mirror_detect/debugCloud", 1);

    icp_in_pub_ = nh_.advertise<pcl::PointCloud<pcl::PointXYZRGB>>("mirror_detect/icp_in_pub", 1);
    icp_target_pub_ = nh_.advertise<pcl::PointCloud<pcl::PointXYZRGB>>("mirror_detect/icp_target_pub", 1);
    icp_out_pub_ = nh_.advertise<pcl::PointCloud<pcl::PointXYZRGB>>("mirror_detect/icp_out_pub", 1);
    cluster_marker_pub=nh_.advertise<visualization_msgs::MarkerArray>( "mirror_detect/marker_cluster", 0 );
  }
  ...
  void clearGlobals()
  {
    ...
    mirror_detect_arr.markers.clear();
  ...
  void configCallback(mirror_detect::DetectionNodeConfig &config,
  ...
  void cloudCallback(const sensor_msgs::PointCloud2ConstPtr &msg)
  {
    ...
    if (clustersPtr_->clusters.size() > 0)
    {
      ...
      case 1: // Bar marker type
        ...
        break;
      case 2:
        DetectLegMarker(clustersPtr_,msg->header.frame_id);
        break;
      case 3:
        DetectMirrorMarker(clustersPtr_,linesPtr_);
      default:
  ...
  void DetectICPMarker(mirror_detect::ClusterArray::Ptr clustersPtr_, std::string frame_id)
  {
    int i = 0;
    ...
    mirror_detect::Cluster::Ptr dockClusterPtr(new mirror_detect::Cluster());
    ...
    std::vector<mirror_detect::Cluster::Ptr> potential;
    std::vector<float> score;
    bool icpSuccess = poseEstimation.clusterArrayICP(clustersPtr_, dockTargetPCLPtr_, dockClusterPtr,potential,score);
    ...
    if (icpSuccess)
    {
      ...
      // {
        ...
        // mirror_detect_arr.markers.push_back(potential[k]->bbox.marker);
        // ROS_INFO("score:%f",score[k]);
          // dock_marker_pub_.publish(potential[k]->bbox.marker);
        
        
      // }
      if(potential.size())dock_marker_pub_.publish(potential[0]->bbox.marker);
 ...
 //=======================================================================================================================================================================================================================================================================================================================================================================================================================================
  //
  // Detect mirror marker 
  //
  //=======================================================================================================================================================================================================================================================================================================================================================================================================================================
void DetectMirrorMarker(mirror_detect::ClusterArray::Ptr clustersPtr_,mirror_detect::LineArray::Ptr linesPtr_)
  {
    int i, j = 0;
    // ROS_INFO("line detect:%zu",linesPtr_->lines.size());
    for (int i = 0; i < linesPtr_->lines.size() - 1; i++)
    {
      ...
      mirror_detect::MinMaxPoint minmax_a = getMinMaxPointMsg(pointCloudXYZ_a);
      ...
      for (int j = i + 1; j < linesPtr_->lines.size(); j++)
      {
        ...
        mirror_detect::MinMaxPoint minmax_b = getMinMaxPointMsg(pointCloudXYZ_b);
  ...
  void DetectLegMarker(mirror_detect::ClusterArray::Ptr clustersPtr_,std::string frame_id)
  {
    ...
    for (int i = 0; i < clustersPtr_->clusters.size(); i++)
    {
      ...
      marker.ns = "marker_arr";
      marker.id = i;  //
      marker.type = visualization_msgs::Marker::CUBE;  
      marker.action = visualization_msgs::Marker::ADD;
      marker.pose.position.x = _centroid.x;
      marker.pose.position.y =_centroid.y;
      marker.scale.x = 0.02;
      marker.scale.y = 0.02;
      marker.scale.z = 0.01;
      marker.color.r = 0.0f;
