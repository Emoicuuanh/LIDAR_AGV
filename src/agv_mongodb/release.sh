...
build_python_file $PACKAGE "scripts/mongodb.py" "--module"
build_python_file $PACKAGE "scripts/dijkstra.py" "--module"
build_python_file $PACKAGE "scripts/load_rfid_to_map.py" "--module"
# build_python_file $PACKAGE "scripts/mongodb.py"
./update_changelog.sh
