...
class CartographerInitialPoseSetter:
    ...
    def initialpose_callback(self, msg):
        ...
        # Init trong carto là init theo hệ tọa độ của trajectory 0, init trong rviz là theo hệ tọa độ map
        # Do đó cần biến đổi init sang hệ tọa độ của trajectory 0
        # Bước 1: Lấy transform từ map đến trajectory 0
        T_submap = self.get_data_transform_map()
        T_init = self.pose_to_mat44(msg.pose.pose)

        # Bước 2: Biến đổi Rviz init sang hệ tọa độ trajectory 0
