-- Dùng để sửa map: rotate, transform trong chế độ MAP_EDITING của MAV
...
-- ═══════════════════════════════════════════════════════════════════════
-- GUIDE LINE TOOL CONFIGURATION
-- Disable auto-optimization để map không tự động deform khi add constraint
-- User phải manually call /improve_map để trigger optimization
-- ═══════════════════════════════════════════════════════════════════════
POSE_GRAPH.optimize_every_n_nodes = 0  -- 0 = Disable auto-optimization
