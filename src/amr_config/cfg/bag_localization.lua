...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 0.01 --0.1
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.angular_search_window = math.rad(5.)--20.)
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.num_threads = 16--4
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher.occupied_space_weight = 100--20.
POSE_GRAPH.constraint_builder.ceres_scan_matcher.translation_weight = 100. --10.
POSE_GRAPH.constraint_builder.ceres_scan_matcher.rotation_weight = 40. --1.
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher.ceres_solver_options.num_threads = 50--4
...
POSE_GRAPH.optimization_problem.ceres_solver_options.num_threads = 16--4
