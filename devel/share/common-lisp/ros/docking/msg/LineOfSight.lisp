...
(cl:defmethod cl:initialize-instance :after ((m <LineOfSight>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LineOfSight)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name docking-msg:<LineOfSight> is deprecated: use docking-msg:LineOfSight instead.")))
...
(cl:defmethod endPoint-val ((m <LineOfSight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader docking-msg:endPoint-val is deprecated.  Use docking-msg:endPoint instead.")
  (endPoint m))
...
(cl:defmethod slope-val ((m <LineOfSight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader docking-msg:slope-val is deprecated.  Use docking-msg:slope instead.")
  (slope m))

(cl:ensure-generic-function 'arrow-val :lambda-list '(m))
(cl:defmethod arrow-val ((m <LineOfSight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader docking-msg:arrow-val is deprecated.  Use docking-msg:arrow instead.")
  (arrow m))

(cl:ensure-generic-function 'delta-val :lambda-list '(m))
(cl:defmethod delta-val ((m <LineOfSight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader docking-msg:delta-val is deprecated.  Use docking-msg:delta instead.")
  (delta m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <LineOfSight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader docking-msg:phi-val is deprecated.  Use docking-msg:phi instead.")
  (phi m))
