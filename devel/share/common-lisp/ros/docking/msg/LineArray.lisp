...
(cl:defmethod cl:initialize-instance :after ((m <LineArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LineArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name docking-msg:<LineArray> is deprecated: use docking-msg:LineArray instead.")))
...
(cl:defmethod combinedCloud-val ((m <LineArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader docking-msg:combinedCloud-val is deprecated.  Use docking-msg:combinedCloud instead.")
  (combinedCloud m))
