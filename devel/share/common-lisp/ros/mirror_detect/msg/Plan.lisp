...
(cl:defmethod cl:initialize-instance :after ((m <Plan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Plan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirror_detect-msg:<Plan> is deprecated: use mirror_detect-msg:Plan instead.")))
...
(cl:defmethod poseArray-val ((m <Plan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:poseArray-val is deprecated.  Use mirror_detect-msg:poseArray instead.")
  (poseArray m))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <Plan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:path-val is deprecated.  Use mirror_detect-msg:path instead.")
  (path m))

(cl:ensure-generic-function 'twists-val :lambda-list '(m))
(cl:defmethod twists-val ((m <Plan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:twists-val is deprecated.  Use mirror_detect-msg:twists instead.")
  (twists m))
