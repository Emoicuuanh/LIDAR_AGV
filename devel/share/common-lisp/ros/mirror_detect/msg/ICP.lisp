...
(cl:defmethod cl:initialize-instance :after ((m <ICP>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ICP)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirror_detect-msg:<ICP> is deprecated: use mirror_detect-msg:ICP instead.")))
...
(cl:defmethod poseStamped-val ((m <ICP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:poseStamped-val is deprecated.  Use mirror_detect-msg:poseStamped instead.")
  (poseStamped m))

(cl:ensure-generic-function 'transformStamped-val :lambda-list '(m))
(cl:defmethod transformStamped-val ((m <ICP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:transformStamped-val is deprecated.  Use mirror_detect-msg:transformStamped instead.")
  (transformStamped m))

(cl:ensure-generic-function 'poseTextMarker-val :lambda-list '(m))
(cl:defmethod poseTextMarker-val ((m <ICP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:poseTextMarker-val is deprecated.  Use mirror_detect-msg:poseTextMarker instead.")
  (poseTextMarker m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <ICP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:score-val is deprecated.  Use mirror_detect-msg:score instead.")
  (score m))
