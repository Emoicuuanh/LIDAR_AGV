...
(cl:defmethod cl:initialize-instance :after ((m <Dock>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Dock)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirror_detect-msg:<Dock> is deprecated: use mirror_detect-msg:Dock instead.")))
...
(cl:defmethod dockCloud-val ((m <Dock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:dockCloud-val is deprecated.  Use mirror_detect-msg:dockCloud instead.")
  (dockCloud m))
