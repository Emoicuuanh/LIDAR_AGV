...
(cl:defclass <Cluster> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bbox
    :reader bbox
    :initarg :bbox
    :type mirror_detect-msg:BoundingBox
    :initform (cl:make-instance 'mirror_detect-msg:BoundingBox))
   (clusterID
    :reader clusterID
    :initarg :clusterID
   ...
   (lines
    :reader lines
    :initarg :lines
    :type mirror_detect-msg:LineArray
    :initform (cl:make-instance 'mirror_detect-msg:LineArray))
   (icp
    :reader icp
    :initarg :icp
    :type mirror_detect-msg:ICP
    :initform (cl:make-instance 'mirror_detect-msg:ICP))
   (icpCombinedCloud
    :reader icpCombinedCloud
    :initarg :icpCombinedCloud
    :type sensor_msgs-msg:PointCloud2
    :initform (cl:make-instance 'sensor_msgs-msg:PointCloud2))
   (isDock
    :reader isDock
   ...
   (potentialDock
    :reader potentialDock
    :initarg :potentialDock
    :type std_msgs-msg:Bool
    :initform (cl:make-instance 'std_msgs-msg:Bool)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Cluster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cluster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirror_detect-msg:<Cluster> is deprecated: use mirror_detect-msg:Cluster instead.")))
...
(cl:defmethod cloud-val ((m <Cluster>))
...
(cl:defmethod bbox-val ((m <Cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:bbox-val is deprecated.  Use mirror_detect-msg:bbox instead.")
  (bbox m))

(cl:ensure-generic-function 'clusterID-val :lambda-list '(m))
(cl:defmethod clusterID-val ((m <Cluster>))
...
(cl:defmethod lines-val ((m <Cluster>))
...
(cl:ensure-generic-function 'icp-val :lambda-list '(m))
(cl:defmethod icp-val ((m <Cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:icp-val is deprecated.  Use mirror_detect-msg:icp instead.")
  (icp m))

(cl:ensure-generic-function 'icpCombinedCloud-val :lambda-list '(m))
(cl:defmethod icpCombinedCloud-val ((m <Cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:icpCombinedCloud-val is deprecated.  Use mirror_detect-msg:icpCombinedCloud instead.")
  (icpCombinedCloud m))

(cl:ensure-generic-function 'isDock-val :lambda-list '(m))
(cl:defmethod isDock-val ((m <Cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:isDock-val is deprecated.  Use mirror_detect-msg:isDock instead.")
  (isDock m))

(cl:ensure-generic-function 'potentialDock-val :lambda-list '(m))
(cl:defmethod potentialDock-val ((m <Cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirror_detect-msg:potentialDock-val is deprecated.  Use mirror_detect-msg:potentialDock instead.")
  (potentialDock m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Cluster>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'lines) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'icp) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'icpCombinedCloud) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'isDock) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'potentialDock) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Cluster>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'lines) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'icp) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'icpCombinedCloud) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'isDock) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'potentialDock) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Cluster>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'lines))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'icp))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'icpCombinedCloud))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'isDock))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'potentialDock))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Cluster>))
  ...
  (cl:list 'Cluster
    ...
    (cl:cons ':icp (icp msg))
    (cl:cons ':icpCombinedCloud (icpCombinedCloud msg))
    (cl:cons ':isDock (isDock msg))
    (cl:cons ':potentialDock (potentialDock msg))
))
