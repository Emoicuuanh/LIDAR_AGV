...
(cl:defclass <RouterStatus> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (current_planning_robot
    :reader current_planning_robot
    :initarg :current_planning_robot
    :type cl:string
    :initform "")
   (active_robots
    :reader active_robots
    :initarg :active_robots
   ...
   (priority_scheduling_attempts
    :reader priority_scheduling_attempts
    :initarg :priority_scheduling_attempts
    :type cl:integer
    :initform 0)
   (speed_scheduling_attempts
    :reader speed_scheduling_attempts
    :initarg :speed_scheduling_attempts
    :type cl:integer
    :initform 0)
   (error_code
    :reader error_code
...
(cl:ensure-generic-function 'current_planning_robot-val :lambda-list '(m))
(cl:defmethod current_planning_robot-val ((m <RouterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tuw_multi_robot_msgs-msg:current_planning_robot-val is deprecated.  Use tuw_multi_robot_msgs-msg:current_planning_robot instead.")
  (current_planning_robot m))

(cl:ensure-generic-function 'active_robots-val :lambda-list '(m))
(cl:defmethod active_robots-val ((m <RouterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tuw_multi_robot_msgs-msg:active_robots-val is deprecated.  Use tuw_multi_robot_msgs-msg:active_robots instead.")
  (active_robots m))
...
(cl:ensure-generic-function 'priority_scheduling_attempts-val :lambda-list '(m))
(cl:defmethod priority_scheduling_attempts-val ((m <RouterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tuw_multi_robot_msgs-msg:priority_scheduling_attempts-val is deprecated.  Use tuw_multi_robot_msgs-msg:priority_scheduling_attempts instead.")
  (priority_scheduling_attempts m))

(cl:ensure-generic-function 'speed_scheduling_attempts-val :lambda-list '(m))
(cl:defmethod speed_scheduling_attempts-val ((m <RouterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tuw_multi_robot_msgs-msg:speed_scheduling_attempts-val is deprecated.  Use tuw_multi_robot_msgs-msg:speed_scheduling_attempts instead.")
  (speed_scheduling_attempts m))

(cl:ensure-generic-function 'error_code-val :lambda-list '(m))
(cl:defmethod error_code-val ((m <RouterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tuw_multi_robot_msgs-msg:error_code-val is deprecated.  Use tuw_multi_robot_msgs-msg:error_code instead.")
  (error_code m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RouterStatus>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'current_planning_robot))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'current_planning_robot))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'active_robots))))
  ...
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) ele))
   (cl:slot-value msg 'active_robots))
  ...
  (cl:let* ((signed (cl:slot-value msg 'priority_scheduling_attempts)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'speed_scheduling_attempts)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RouterStatus>) istream)
  "Deserializes a message object of type '<RouterStatus>"
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'current_planning_robot) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'current_planning_robot) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'active_robots) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'active_robots)))
  ...
  (cl:let ((vals (cl:slot-value msg 'missing_robots)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'priority_scheduling_attempts) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'speed_scheduling_attempts) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RouterStatus>)))
  ...
  "12b84073f615141f7e5cf477f238bb5b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RouterStatus)))
  "Returns md5sum for a message object of type 'RouterStatus"
  "12b84073f615141f7e5cf477f238bb5b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RouterStatus>)))
  ...
  (cl:format cl:nil "#################################################################~%## A message to publish the status of the last route~%## generation~%#################################################################~%~%int32 id # the unique id of the new plan~%bool success # true if a routing table was found to the given scenario~%string current_planning_robot~%string[] active_robots~%string[] missing_robots # if the plan fails because of absent robots, these robots are listed here~%int32 duration # the time until a routing table was found~%int32 overall_path_length # the overall path length in the routing table (calculated using weights)~%int32 longest_path_length # the longest path length in a routing table (calculated using weights)~%int32 priority_scheduling_attempts # shows how often robot priorities are exchanged~%int32 speed_scheduling_attempts # shows how many robots speed was reduced during planning~%string error_code~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RouterStatus)))
  "Returns full string definition for message of type 'RouterStatus"
  (cl:format cl:nil "#################################################################~%## A message to publish the status of the last route~%## generation~%#################################################################~%~%int32 id # the unique id of the new plan~%bool success # true if a routing table was found to the given scenario~%string current_planning_robot~%string[] active_robots~%string[] missing_robots # if the plan fails because of absent robots, these robots are listed here~%int32 duration # the time until a routing table was found~%int32 overall_path_length # the overall path length in the routing table (calculated using weights)~%int32 longest_path_length # the longest path length in a routing table (calculated using weights)~%int32 priority_scheduling_attempts # shows how often robot priorities are exchanged~%int32 speed_scheduling_attempts # shows how many robots speed was reduced during planning~%string error_code~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RouterStatus>))
  (cl:+ 0
     4
     1
     4 (cl:length (cl:slot-value msg 'current_planning_robot))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'active_robots) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RouterStatus>))
  ...
  (cl:list 'RouterStatus
    ...
    (cl:cons ':current_planning_robot (current_planning_robot msg))
    (cl:cons ':active_robots (active_robots msg))
    ...
    (cl:cons ':priority_scheduling_attempts (priority_scheduling_attempts msg))
    (cl:cons ':speed_scheduling_attempts (speed_scheduling_attempts msg))
