...
(cl:defclass <RoutePrecondition> (roslisp-msg-protocol:ros-message)
  ((robot_id
   ...
   (current_route_segment
    ...
    :initform 0)
   (current_segment_id
    :reader current_segment_id
    :initarg :current_segment_id
    :type cl:integer
    :initform 0))
)
...
(cl:ensure-generic-function 'current_segment_id-val :lambda-list '(m))
(cl:defmethod current_segment_id-val ((m <RoutePrecondition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tuw_multi_robot_msgs-msg:current_segment_id-val is deprecated.  Use tuw_multi_robot_msgs-msg:current_segment_id instead.")
  (current_segment_id m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RoutePrecondition>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'current_segment_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'current_segment_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 16) (cl:slot-value msg 'current_segment_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 24) (cl:slot-value msg 'current_segment_id)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RoutePrecondition>) istream)
  "Deserializes a message object of type '<RoutePrecondition>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'current_segment_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'current_segment_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) (cl:slot-value msg 'current_segment_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) (cl:slot-value msg 'current_segment_id)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RoutePrecondition>)))
  ...
  "0afe59a3c04015283c2ce1161adf2e35")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RoutePrecondition)))
  "Returns md5sum for a message object of type 'RoutePrecondition"
  "0afe59a3c04015283c2ce1161adf2e35")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RoutePrecondition>))
  ...
  (cl:list 'RoutePrecondition
    ...
    (cl:cons ':current_segment_id (current_segment_id msg))
))
