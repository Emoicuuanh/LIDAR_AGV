...
if("TRUE" STREQUAL "TRUE")
  set(ros_arduino_firmware_SOURCE_PREFIX /home/mkac/mav_ws/src/ros_arduino_bridge/ros_arduino_firmware)
  set(ros_arduino_firmware_DEVEL_PREFIX /home/mkac/mav_ws/devel)
  ...
  set(ros_arduino_firmware_INSTALL_PREFIX /home/mkac/mav_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkac/mav_ws/src/ros_arduino_bridge/ros_arduino_firmware/${idir}'.  ${_report}")
    endif()
