...
if("TRUE" STREQUAL "TRUE")
  set(yocs_ar_pair_tracking_SOURCE_PREFIX /home/mkac/mav_ws/src/yujin_ocs/yocs_ar_pair_tracking)
  set(yocs_ar_pair_tracking_DEVEL_PREFIX /home/mkac/mav_ws/devel)
  ...
  set(yocs_ar_pair_tracking_INSTALL_PREFIX /home/mkac/mav_ws/install)
...
if(NOT "/home/mkac/mav_ws/src/yujin_ocs/yocs_ar_pair_tracking/include;/usr/include " STREQUAL " ")
  set(yocs_ar_pair_tracking_INCLUDE_DIRS "")
  set(_include_dirs "/home/mkac/mav_ws/src/yujin_ocs/yocs_ar_pair_tracking/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_ar_pair_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkac/mav_ws/src/yujin_ocs/yocs_ar_pair_tracking/${idir}'.  ${_report}")
    endif()
    _list_append_unique(yocs_ar_pair_tracking_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "yocs_ar_pair_tracking;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(yocs_ar_pair_tracking_EXPORTED_TARGETS ${${yocs_ar_pair_tracking_dep}_EXPORTED_TARGETS})
endforeach()
