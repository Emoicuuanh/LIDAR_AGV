...
if("TRUE" STREQUAL "TRUE")
  set(yocs_ar_marker_tracking_SOURCE_PREFIX /home/mkac/mav_ws/src/yujin_ocs/yocs_ar_marker_tracking)
  set(yocs_ar_marker_tracking_DEVEL_PREFIX /home/mkac/mav_ws/devel)
  ...
  set(yocs_ar_marker_tracking_INSTALL_PREFIX /home/mkac/mav_ws/install)
...
if(NOT "/home/mkac/mav_ws/src/yujin_ocs/yocs_ar_marker_tracking/include;/usr/include " STREQUAL " ")
  set(yocs_ar_marker_tracking_INCLUDE_DIRS "")
  set(_include_dirs "/home/mkac/mav_ws/src/yujin_ocs/yocs_ar_marker_tracking/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_ar_marker_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkac/mav_ws/src/yujin_ocs/yocs_ar_marker_tracking/${idir}'.  ${_report}")
    endif()
    _list_append_unique(yocs_ar_marker_tracking_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "yocs_ar_marker_tracking;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0;yaml-cpp")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT yocs_ar_marker_tracking_NUM_DUMMY_TARGETS)
      set(yocs_ar_marker_tracking_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::yocs_ar_marker_tracking::wrapped-linker-option${yocs_ar_marker_tracking_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR yocs_ar_marker_tracking_NUM_DUMMY_TARGETS "${yocs_ar_marker_tracking_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::yocs_ar_marker_tracking::wrapped-linker-option${yocs_ar_marker_tracking_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND yocs_ar_marker_tracking_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(yocs_ar_marker_tracking_EXPORTED_TARGETS ${${yocs_ar_marker_tracking_dep}_EXPORTED_TARGETS})
endforeach()
