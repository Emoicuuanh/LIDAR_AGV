...
class ClusterArray {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('combinedCloud')) {
        this.combinedCloud = initObj.combinedCloud
      }
      else {
        this.combinedCloud = new sensor_msgs.msg.PointCloud2();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [combinedCloud]
    bufferOffset = sensor_msgs.msg.PointCloud2.serialize(obj.combinedCloud, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [combinedCloud]
    data.combinedCloud = sensor_msgs.msg.PointCloud2.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += sensor_msgs.msg.PointCloud2.getMessageSize(object.combinedCloud);
  ...
  static Resolve(msg) {
    ...
    if (msg.combinedCloud !== undefined) {
      resolved.combinedCloud = sensor_msgs.msg.PointCloud2.Resolve(msg.combinedCloud)
    }
    else {
      resolved.combinedCloud = new sensor_msgs.msg.PointCloud2()
    }
