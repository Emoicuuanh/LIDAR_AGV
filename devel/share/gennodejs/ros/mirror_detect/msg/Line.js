...
class Line {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('coefficients')) {
        ...
        this.coefficients = new pcl_msgs.msg.ModelCoefficients();
      }
      if (initObj.hasOwnProperty('centroid')) {
        this.centroid = initObj.centroid
      }
      else {
        this.centroid = new geometry_msgs.msg.Pose();
      }
      ...
      if (initObj.hasOwnProperty('lineID')) {
        ...
        this.lineID = new std_msgs.msg.Int32();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = pcl_msgs.msg.ModelCoefficients.serialize(obj.coefficients, buffer, bufferOffset);
    // Serialize message field [centroid]
    bufferOffset = geometry_msgs.msg.Pose.serialize(obj.centroid, buffer, bufferOffset);
    ...
    bufferOffset = std_msgs.msg.Int32.serialize(obj.lineID, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.coefficients = pcl_msgs.msg.ModelCoefficients.deserialize(buffer, bufferOffset);
    // Deserialize message field [centroid]
    data.centroid = geometry_msgs.msg.Pose.deserialize(buffer, bufferOffset);
    ...
    data.lineID = std_msgs.msg.Int32.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += pcl_msgs.msg.ModelCoefficients.getMessageSize(object.coefficients);
  ...
  static Resolve(msg) {
    ...
    if (msg.coefficients !== undefined) {
      resolved.coefficients = pcl_msgs.msg.ModelCoefficients.Resolve(msg.coefficients)
    }
    else {
      resolved.coefficients = new pcl_msgs.msg.ModelCoefficients()
    }

    if (msg.centroid !== undefined) {
      resolved.centroid = geometry_msgs.msg.Pose.Resolve(msg.centroid)
    }
    else {
      resolved.centroid = new geometry_msgs.msg.Pose()
    }
    ...
    if (msg.lineID !== undefined) {
      resolved.lineID = std_msgs.msg.Int32.Resolve(msg.lineID)
    }
    else {
      resolved.lineID = new std_msgs.msg.Int32()
    }
