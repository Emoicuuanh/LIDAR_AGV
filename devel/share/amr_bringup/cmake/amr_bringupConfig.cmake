...
if("TRUE" STREQUAL "TRUE")
  set(amr_bringup_SOURCE_PREFIX /home/mkac/mav_ws/src/00.amr/amr_bringup)
  set(amr_bringup_DEVEL_PREFIX /home/mkac/mav_ws/devel)
  ...
  set(amr_bringup_INSTALL_PREFIX /home/mkac/mav_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amr_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkac/mav_ws/src/00.amr/amr_bringup/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(amr_bringup_EXPORTED_TARGETS ${${amr_bringup_dep}_EXPORTED_TARGETS})
endforeach()
