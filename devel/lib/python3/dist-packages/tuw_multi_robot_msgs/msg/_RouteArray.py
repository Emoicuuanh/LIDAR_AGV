...
"""autogenerated by genpy from tuw_multi_robot_msgs/RouteArray.msg. Do not edit."""
import codecs
import sys
...
class RouteArray(genpy.Message):
  _md5sum = "68e00687fc15821fd35f16dce9cc143b"
  _type = "tuw_multi_robot_msgs/RouteArray"
...
float64 w
"""
  __slots__ = ['header','id_request','routes']
  _slot_types = ['std_msgs/Header','string','tuw_multi_robot_msgs/Route[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RouteArray, self).__init__(*args, **kwds)
    ...
    try:
      ...
      for val1 in self.routes:
        ...
        for val2 in val1.segments:
          _x = val2.segment_id
          buff.write(_get_struct_i().pack(_x))
          length = len(val2.preconditions)
          buff.write(_struct_I.pack(length))
          for val3 in val2.preconditions:
            _x = val3.robot_id
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
          ...
          _x = _v8
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          _x = val2.start_properties
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _x = val2.end_properties
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
            length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.id_request = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.id_request = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.routes = []
      for i in range(0, length):
        val1 = tuw_multi_robot_msgs.msg.Route()
        _v9 = val1.header
        start = end
        end += 4
        ...
        if python3:
          val1.id_request = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.id_request = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.segments = []
        for i in range(0, length):
          val2 = tuw_multi_robot_msgs.msg.RouteSegment()
          start = end
          end += 4
          (val2.segment_id,) = _get_struct_i().unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.preconditions = []
          for i in range(0, length):
            val3 = tuw_multi_robot_msgs.msg.RoutePrecondition()
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            start = end
            ...
            if python3:
              val3.robot_id = str[start:end].decode('utf-8', 'rosmsg')
            else:
              val3.robot_id = str[start:end]
            _x = val3
            start = end
            end += 8
            (_x.current_route_segment, _x.current_segment_id,) = _get_struct_iI().unpack(str[start:end])
            val2.preconditions.append(val3)
          _v11 = val2.start
          _v12 = _v11.position
          _x = _v12
          start = end
          ...
          if python3:
            val2.start_properties = str[start:end].decode('utf-8', 'rosmsg')
          else:
            val2.start_properties = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
          ...
          if python3:
            val2.end_properties = str[start:end].decode('utf-8', 'rosmsg')
          else:
            val2.end_properties = str[start:end]
          start = end
          end += 4
