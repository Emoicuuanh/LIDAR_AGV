...
"""autogenerated by genpy from tuw_multi_robot_msgs/RobotGoalsArray.msg. Do not edit."""
import codecs
import sys
...
class RobotGoalsArray(genpy.Message):
  _md5sum = "6907aee3ef10041939eeaebc1d873864"
  _type = "tuw_multi_robot_msgs/RobotGoalsArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','tuw_multi_robot_msgs/RobotGoals[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobotGoalsArray, self).__init__(*args, **kwds)
    ...
    try:
      ...
      for val1 in self.robots:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(val1.destinations)
        buff.write(_struct_I.pack(length))
        for val2 in val1.destinations:
          _v1 = val2.position
          _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tuw_multi_robot_msgs.msg.RobotGoals()
        start = end
        end += 4
