...
"""autogenerated by genpy from tuw_multi_robot_msgs/RoutePrecondition.msg. Do not edit."""
import codecs
import sys
...
class RoutePrecondition(genpy.Message):
  _md5sum = "0afe59a3c04015283c2ce1161adf2e35"
  _type = "tuw_multi_robot_msgs/RoutePrecondition"
...
uint32 current_segment_id"""
  __slots__ = ['robot_id','current_route_segment','current_segment_id']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       robot_id,current_route_segment,current_segment_id
    ...
    """
    if args or kwds:
      super(RoutePrecondition, self).__init__(*args, **kwds)
