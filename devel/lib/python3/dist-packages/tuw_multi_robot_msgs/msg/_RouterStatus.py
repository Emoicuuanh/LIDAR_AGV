...
class RouterStatus(genpy.Message):
  _md5sum = "12b84073f615141f7e5cf477f238bb5b"
...
string error_code"""
  __slots__ = ['id','success','current_planning_robot','active_robots','missing_robots','duration','overall_path_length','longest_path_length','priority_scheduling_attempts','speed_scheduling_attempts','error_code']
  _slot_types = ['int32','bool','string','string[]','string[]','int32','int32','int32','int32','int32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,success,current_planning_robot,active_robots,missing_robots,duration,overall_path_length,longest_path_length,priority_scheduling_attempts,speed_scheduling_attempts,error_code
    ...
    if args or kwds:
      ...
      if self.success is None:
        self.success = False
      if self.current_planning_robot is None:
        self.current_planning_robot = ''
      if self.active_robots is None:
        self.active_robots = []
      ...
      if self.priority_scheduling_attempts is None:
        self.priority_scheduling_attempts = 0
      if self.speed_scheduling_attempts is None:
        self.speed_scheduling_attempts = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.current_planning_robot
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.active_robots)
      buff.write(_struct_I.pack(length))
      for val1 in self.active_robots:
        length = len(val1)
      ...
      for val1 in self.missing_robots:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self
      buff.write(_get_struct_5i().pack(_x.duration, _x.overall_path_length, _x.longest_path_length, _x.priority_scheduling_attempts, _x.speed_scheduling_attempts))
      _x = self.error_code
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.current_planning_robot = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.current_planning_robot = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.active_robots = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.active_robots.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.missing_robots = []
      ...
      (_x.duration, _x.overall_path_length, _x.longest_path_length, _x.priority_scheduling_attempts, _x.speed_scheduling_attempts,) = _get_struct_5i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
