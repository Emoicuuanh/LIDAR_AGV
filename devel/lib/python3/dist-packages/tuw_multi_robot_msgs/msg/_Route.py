...
class Route(genpy.Message):
  _md5sum = "70f83a8454641f693d6ff2ae475e7093"
...
float64 w
"""
  __slots__ = ['header','robot_name','id_request','segments']
  _slot_types = ['std_msgs/Header','string','string','tuw_multi_robot_msgs/RouteSegment[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,robot_name,id_request,segments
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.segments:
        ...
        _x = _v6
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = val1.start_properties
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1.end_properties
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.start_properties = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.start_properties = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.end_properties = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.end_properties = str[start:end]
        start = end
        end += 4
