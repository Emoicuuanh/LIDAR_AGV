...
"""autogenerated by genpy from docking/DockingAction.msg. Do not edit."""
import codecs
import sys
...
class DockingAction(genpy.Message):
  _md5sum = "5cda62aec1ad991ba991206b2df3a74a"
  _type = "docking/DockingAction"
...
"""
  ...
  _slot_types = ['docking/DockingActionGoal','docking/DockingActionResult','docking/DockingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DockingAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = docking.msg.DockingActionGoal()
      if self.action_result is None:
        self.action_result = docking.msg.DockingActionResult()
      if self.action_feedback is None:
        self.action_feedback = docking.msg.DockingActionFeedback()
    else:
      self.action_goal = docking.msg.DockingActionGoal()
      self.action_result = docking.msg.DockingActionResult()
      self.action_feedback = docking.msg.DockingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.beginDocking, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.beginDocking, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.action_goal.goal.beginDocking = bool(self.action_goal.goal.beginDocking)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
