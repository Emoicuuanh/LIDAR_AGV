...
"""autogenerated by genpy from docking/DockingActionResult.msg. Do not edit."""
import codecs
import sys
...
class DockingActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "docking/DockingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','docking/DockingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DockingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = docking.msg.DockingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = docking.msg.DockingResult()
